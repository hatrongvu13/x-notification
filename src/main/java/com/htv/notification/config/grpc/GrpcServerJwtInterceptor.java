package com.htv.notification.config.grpc;

import com.htv.notification.annotation.PublicGrpc;
...
public class GrpcServerJwtInterceptor implements ServerInterceptor {
    ...
    private Method findGrpcMethod(Object service, String serviceName) {
        for (Method method : service.getClass().getMethods()) {
            if (method.getDeclaringClass().getName().equals(serviceName)) {
                return method;
            }
        }
        return null;
